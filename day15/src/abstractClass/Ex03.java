...
// interface는 추상 클래스의 일종이다
// interface의 모든 필드는 public static field이다
// interface의 모든 메서드는 public abstract이다
// interface는 extends가 아니라 implements 키워드로 상속처리한다 (인터페이스를 구현한다 라고 표현함)
// interface는 자바에서 유일하게 다중 상속을 허용하는 형식이다
