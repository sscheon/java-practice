...
<form action="modify-action.jsp" method="POST">
	...
	<p>메뉴이름 : <input type="text" name="name" placeholder="메뉴이름" value="${dto.name }" readonly></p>
	...
	<p>이미지 : <input type="file" name="imgPath" placeholder="이미지" value="img/${dto.imgPath }" required></p>
	<p>삭제 여부 : 
