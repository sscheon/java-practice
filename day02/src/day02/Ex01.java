...
public class Ex01 {
	public static void main(String[] args) throws Exception {
		...
		// 2바이트 입력기를 시용하여 문장단위 입력을 처리하는 객체를 생성한다
		...
		String path = "C:\\windows\\system32\\drivers\\ect\\hosts";
		File f = new File(path);
		Scanner sc2 = new Scanner(f);
		
		while(sc2.hasNextLine()) {			// 파일을 읽어내지 않은 다음 줄이 있으면
			String line = sc2.nextLine();	// 한줄을 읽어내서 (\n 이전까지)
			System.out.println(line);		// 그줄을 화면에 출력한다
		}
