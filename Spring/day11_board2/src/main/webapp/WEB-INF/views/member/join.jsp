...
<form method="POST">
	...
	<textarea class="agreement">${agreement }</textarea>
		<p>
			<label>
				...
				<input type="checkbox" name="agreement" required disabled>
			</label>
		</p>
	</fieldset>
	...
	<p>
		...
		<input type="button" name="dupCheck" value="중복체크">
...
<script>
	// 스프링의 특정 주소로 요청하여 결과를 받고, 결과에 따라서 다른 메세지를 만들어내는 자바스크립트(AJAX)
