...
public class Ex03 {
	public static void main(String[] args) {
		...
		// 바라보는 대상이 일치하는가?
		System.out.println("t1 == t2 : " + t1 == t2); // 바라보는 대상이 다르므로 false
		System.out.println("t1 == t3 : " + t1 == t3); // 바라보는 대상이 똑같으므로 true
