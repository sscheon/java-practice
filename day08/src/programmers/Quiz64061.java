...
// 코딩테스트 연습 - 2019 카카오 개발자 겨울 인턴쉽 - 크레인 인형뽑기 게임
...
//        	if(basket.contains(doll + "" + doll))		// 똑같은 숫자 2개로 끝날때 쓸수있는 함수
        	if(basket.contains(doll + "" + doll)) {		// 바구니에서 방금 뽑은 종류의 인형이 연속으로 2개 있으면
