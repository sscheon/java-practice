...
<style>
	...
	h2 > span:nth-child(4) { color: lightgreen; }
...
<h3>클라이언트 서버에게 보내는 요청을 객체화한 요소.jsp 내장객체 중 하나</h3>
<table>
	<tr>
		<td>메서드</td>
		<td>기능</td>
	...
	<tr>
		<td>getRequestURL()</td>
		<td>요청받은 전체 주소(프로토콜 + 서버이름 + 서버포트 : URI (contextPath + 파일이름)) + 쿼리스트링</td>
	...
	<tr>
		...
		<td>
			...
			<a href="ex01.jsp?name=son&age=30"><button>예시</button></a>
		</td>
...
<h2>
	<span>http</span>://<span>localhost</span>:<span>8080</span><span>/day02</span><span>/ex01.jsp</span><span>?name=son&age=30</span>	
</h2>
<h2>
	<span>프로토콜</span>://<span>서버이름</span>:<span>서버포트</span><span>문서경로</span><span>문서이름</span><span>쿼리스트링</span>	
</h2>
