...
class Test3{
	int n1 = 10;			// 객체를 통해서 접근
	static int n2 = 20;		// 클래스를 통해서 접근
	
	void showN1() {				// non-static
		System.out.println(n1);
	}
	
	static void showN2() {			// static 필드를 참조하는 메서드는
		System.out.println(n2);		// 동일하게 static을 지정해야 제 기능을 수행할 수 있다
...
//		Test3.showN1();		// static이 아니어서 접근 불가 (non-static)
		Test3.showN2();		
