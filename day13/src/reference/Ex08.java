...
class Kid{
	...
	void throwBall(Kid other) {	// 다른아이를 지정하여 대상에게 공을 넘겨주고, 자신의 공은 사라지는 함수
...
class Ball {}	// 아무 내용도 없지만 기본 생성자가 만들어진다
...
public class Ex08 {
	public static void main(String[] args) {
		...
		ob1.throwBall(ob2);		// 찬혁이가 들고있던 공을 지용이에게 던졌다
		ob2.throwBall(ob1);		// 지용이가 들고있던 공을 찬혁이에게 던졌다
		
		// 실체가 없는 사람이 들고있던 공을 지용이에게 던졌다
