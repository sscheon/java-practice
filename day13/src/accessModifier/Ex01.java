...
//		System.out.println(ob.n1); // The field Test1.n1 is not visible
		ob.showN1();		// 필드에 직접적으로 접근 할 수는 없지만, 메서드를 통하여 출력을 할 수는 있다
...
//		ob.n1 += 4;		// The field Test1.n1 is not visible
		ob.n2 += 4;		// 서로 다른 클래스이지만, 같은 패키지 내에 속해있다
		ob.n3 += 4;		// 상속은 아니지만 같은 패키지
		ob.n4 += 4;		// 동일 클래스 여부에 상관없이 누구에게나 접근을 허용한다
